---
description: Equipment Installation and Wiring
---
...
* The recommended length for the AC cable between the inverter and the upstream transformer should be ≤ 600 meters. If the length exceeds 600 meters, it may affect the parallel operation of the inverters. Please contact Sigenergy for further advice.
