...
* 禁止将设备安装于强电磁干扰的环境中。
* 安装环境的温度与湿度要符合设备要求。
* 设备应安装于距高盐或高酸等腐蚀源≥1640.42ft（500m）的地区（腐蚀源包括但不限于海边、火电厂、化工厂、冶炼厂、煤厂、橡胶厂、电镀厂等）。
* 在海洋环境良好（挪威等近岸盐度 ≤ 28psu）的地区，设备安装距海岸线区域可适当放宽至≥656.17ft（200m）。
...
* 设备运行会发热。若将设备安装于室内，请确保室内通风良好，禁止出现由于设备运行而导致室内温度升高超过37.4°F (3℃)的情况，避免温度升高导致设备降额。
...
<div align="center"><figure><img src=".gitbook/assets/SEA1SF00002-zh.png" alt=""><figcaption></figcaption></figure></div>

{% include ".gitbook/includes/tips.md" %}

<mark style="color:blue;">在不同安装环境下，实际距离会存在误差，图示仅供参考。</mark>
