...
<mark style="color:blue;">The energy storage system supports multiple working modes, Some countries support Load Shedding Mode, VPP Scheduling-evergen Mode, which is subject to the App interface display.</mark>
