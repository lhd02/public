...
## What should you do if you have not received emails (verification code or logs) from the system? <a href="#toc191308984" id="toc191308984"></a>
...
2. Click <img src=".gitbook/assets/image (42).png" alt="" data-size="line"> next to the station name and click "License Activation" in General → Enter the "License Key".
...
If the power station has activated Sigen AI mode, click the <img src=".gitbook/assets/image (42).png" alt="" data-size="line"> next to the station name → Click "Operational Mode" → Click "Current Mode" → Select "Sigen AI mode" to view the earnings and income calendar for Sigen AI mode.
