...
On the device interface, click the smart load you want to configure → click " ![](<../../../.gitbook/assets/image (2) (1) (1).png>)" in the upper right corner to set the smart load parameters.
