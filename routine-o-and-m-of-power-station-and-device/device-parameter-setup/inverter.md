...
<table><thead><tr><th width="63" align="center">No.</th><th width="241">Parameter name</th><th>Description</th></tr></thead><tbody><tr><td align="center">1</td><td>AFCI Enables</td><td>When it is set to <img src="../../.gitbook/assets/10 (1).png" alt="" data-size="line">, the device will conduct the DC arc testing.</td></tr></tbody></table>
