...
1. On the "Home" screen, click the name of the station where the device is installed.
2. Click the device in the energy flow chart in the "System" tab or the "Device" tab.
3. Download device logs on the "Log Download" screen.
