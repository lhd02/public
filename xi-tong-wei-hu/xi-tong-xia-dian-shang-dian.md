...
* 若电流≤0.01A，请执行下一步操作。
* 若电流＞0.01A，需等待晚上太阳辐照度降低，光伏组串电流降低至0.01A以下时,执行下一步操作。

打开维护腔门，用万用表测量交流端子排对地电压确保逆变器交流侧\
已 断电。

4. 将逆变器上的“DC SWITCH”旋转至“OFF”状态。
5. 长按BC/BC-BST的ON/OFF按钮10s。
6. 设备LED指示灯均熄灭后，请参考设备上延时标签，等待对应的时间后，再进行操作。
