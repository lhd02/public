...
* <mark style="color:red;">为了避免人身伤害和设备损坏，对逆变器或外部组串进行故障排查或更换操作时，在拔除PV端子前，必须用钳流表直流档测量组串电流（即使直流开关已经分闸），确保组串无电流，快速拔插端子进行调整。</mark>
...
6. 逆变器和BC/BC-BST的LED指示灯均熄灭后，请参考设备上延时标签，等待对应的时间后，将BC/BC-BST的隔离开关置于OFF位置。
...
2. 闭合备电配电单元内与设备连接的开关。
3. 将逆变器上的所有“DC SWITCH”旋转至“ON”状态。
4. 观察逆变器和BC/BC-BST的LED指示灯状态，通过App下发开机指令，（操作步骤参见“系统下电”的步骤1描述）
