...
<mark style="color:blue;">Higher output current results in greater charging power.</mark>

### Manual adjustment

<figure><img src="../.gitbook/assets/SSA1CM00069-充电电流调整.jpg" alt="" width="563"><figcaption></figcaption></figure>

### Automatic adjustment of DLM

{% include "https://app.gitbook.com/s/UbDQx7leHsTF4wXWth5S/~/reusable/v0ROOBJtnqMcvClWk0gj/" %}

<mark style="color:blue;">You must install a Power Sensor in the networking.</mark>
...
On the "Home"screen，click "START"or"STOP"

&#x20;

### PV charging or PV storage & charging application

On the "Device" screen, click "AC Cahrge", and click "START"or "STOP".
