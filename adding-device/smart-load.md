...
<mark style="color:blue;">If Shelly is not configured to the same WLAN as SigenStor, you can connect your mobile phone to Shelly via Bluetooth to configure Shelly onto the same WLAN as SigenStor and establish communication.</mark>

<figure><img src="../.gitbook/assets/SSA1CM00072-Bluetooth add shelly.png" alt=""><figcaption></figcaption></figure>

{% include "../.gitbook/includes/tips.md" %}

<mark style="color:blue;">If Shelly is already configured to the same WLAN as SigenStor, you can connect both your mobile phone and SigenStor to the same WLAN as Shelly to establish communication.</mark>
